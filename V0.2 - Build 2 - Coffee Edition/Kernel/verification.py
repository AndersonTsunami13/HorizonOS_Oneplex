...
from Engine.UI_Engine_ConsoleX import escrever, time_s, titulo_console, cursor, loading3, loading7

def system_verification(a=True): # se for True aparece "Pressione para..." e False não mostra.
    titulo_console("verificando...")
    cursor(False)
    loading3(3, "iniciando verificação", "YELLOW")
    loading7()
    time_s(1)
    ...
    if versao.major == 3 and versao.minor >= 11:
        ...
        titulo_console("Error, Você não possui a versao 3.11 do python...")
